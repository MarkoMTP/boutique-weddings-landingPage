...
const steps = [
  ...
  },
  {
    ...
    image: "/images/destinations/umbria.jpg"
  },
  {
    number: "03",
    title: "Deliver",
    ...
    image: "/images/destinations/apulia.jpg"
  },
]
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-1/2 relative">
                {/* Dot on the timeline */}
                <div className={`absolute top-12 hidden lg:block w-3 h-3 rounded-full bg-charcoal ${
